...
fname = 'ijcaibestacctwomasknowunoembedsoftmaxregular3e-4copy.h5'
#with open('ijcaibestacctwomasknowunoembedsoftmaxregular3e-4copy.h5', 'r') as f:
...
proba = model.predict({'main_input': testdataint, 'aux_input': testdataaux})
print(len(proba), proba[0].shape, proba[1].shape, testdataint.shape)

np.save('bestpredy.npy', proba[0])
np.save('truey.npy', testlabel)
# In[ ]:
